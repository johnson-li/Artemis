...
do
    ...
    for row in $(cat ${root}/index.csv); do
        echo sudo LD_LIBRARY_PATH=${root} ${root}/client_transport ${target} 4433 -i -w $row -q 2> ${root}/client_sid.log
        sudo LD_LIBRARY_PATH=${root} ${root}/client_transport ${target} 4433 -i -w $row -q 2> ${root}/client_sid.log
        ...
        echo sudo LD_LIBRARY_PATH=${root} ${root}/client_transport ${target_anycast} 4433 -i -w $row -q 2> ${root}/client_anycast.log
        sudo LD_LIBRARY_PATH=${root} ${root}/client_transport ${target_anycast} 4433 -i -w $row -q 2> ${root}/client_anycast.log
        ...
        echo sudo LD_LIBRARY_PATH=${root} ${root}/client_transport ${target_server} 4433 -i -w $row -q 2> ${root}/client_dns.log
        sudo LD_LIBRARY_PATH=${root} ${root}/client_transport ${target_server} 4433 -i -w $row -q 2> ${root}/client_dns.log
