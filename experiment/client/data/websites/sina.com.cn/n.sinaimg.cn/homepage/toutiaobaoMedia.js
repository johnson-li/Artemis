					...
					sinaads_fail_handler: function() {
						if(leadNewsData.focusPicture.state != 'true') {
							...
							if(leadNewsData.headlinePoster != 'undefined' && leadNewsData.headlinePoster.state === 'true') {
								...
								// 中间视频
								if(leadNewsData.videoTmp.videoOrLive !==''&&leadNewsData.videoTmp.videoOrLive=='live'){
									// 直播视频
										...
										videoTmpBody.id = 'videoTmpBody';
										monbox.getMain().appendChild(videoTmpBody);
										
										var script = document.createElement("script");
										script.type = "text/javascript";
										script.src = "//sjs0.sinajs.cn/video/live/player/v1/coconutplayer.js";
										monbox.getMain().appendChild(script);

										var script1 = document.createElement("script");
										script1.type = "text/javascript";
										script1.src = "//sjs0.sinajs.cn/video/live/player/v1/sinaliveplayer.js";
										monbox.getMain().appendChild(script1);
										
										var script2 = document.createElement("script");
										script2.type = "text/javascript";
										script2.text = "setTimeout(function(){var player = sinaLivePlayer({containerId: 'videoTmpBody',videoId: 'myVideo',liveId: '"+leadNewsData.videoTmp.liveID+"',autoPlay:'true',lov: 1});player.played();player.on('canplay',function(){player.volume(0.5);})},1000)";
										monbox.getMain().appendChild(script2);
										
								}else if(leadNewsData.videoTmp.videoOrLive =='video'){
									var videoTmpBody = me.videoTmpBody = document.createElement('div');
									videoTmpBody.style.cssText = 'width: 300px;height: 169px;background-color: #000;';
