...
SHM.register("home.picGuess", function(g) {
    ...
    c.include({
        ...
        setOpt: function(t) {
            var s = this;
            s.opt = s.opt || {
                api: "//cre.mix.sina.com.cn/api/v3/get?cre=sinapc&mod=picg&statics=1&merge=3&type=1&length=20&cateid=t_s&fields=url_https,url,stitle,title,thumb",
                type: "cate_interest"
            };
            s.evs = {
    ...
    var j = function(y) {
        ...
        var F = function(L) {
            ...
            var J = '<div class="scroll-item"><a href="' + L.url_https + '" target="_blank"  suda-uatrack="' + A + '"><span class="scroll-img"><img src="//z0.sinaimg.cn/auto/resize?img=' + L.thumb + '&size=198_132" /><i></i></span><span class="scroll-txt">' + K + "</span></a></div>";
            H.push(J);
            v++;
        };
